...
## Code
From modifying the original Ankush’s github repository, we can generate our own English text and change background picture arbitrarily, including detecting depth with one single picture, segmenting the picture into different geometries. 
...
Thanks to https://github.com/JarveeLee/SynthText_Chinese_version and after fixing some problem in https://github.com/JarveeLee/SynthText_Chinese_version/issues/1
